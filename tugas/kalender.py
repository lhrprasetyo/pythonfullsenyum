...
# bulan ke 7
    ...
    if tanggal >=1 and tanggal <=29 :
        print("Dzulhijjah 1443")
    if tanggal == 30 or tanggal == 31 :
        print ("Muharram 1443")
# bulan ke 8
elif bulan == 8 :
    if tanggal >= 1 and tanggal <= 28 :
        print("Muharram 1443")
    if tanggal >= 29 and tanggal <=31 :
        print ("Shafar 1443")
# bulan ke 9
elif bulan == 9 :
    if tanggal >= 1 and tanggal <= 26 :
        print("Shafar 1443")
    if tanggal >= 27 and tanggal <=30 :
        print ("Rabi'ul Awwal 1443")
# bulan ke 10
elif bulan == 10 :
    if tanggal >= 1 and tanggal <= 26 :
        print("Rabi'ul Awwal 1443")
    if tanggal >= 27 and tanggal <=31 :
